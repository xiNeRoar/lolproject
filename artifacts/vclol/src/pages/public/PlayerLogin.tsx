      ...
      <div className="max-w-sm mx-auto px-4 pt-24 pb-16">
        ...
        <Card className="border-border/40 bg-card/60">
          <CardContent className="pt-8 pb-8 flex flex-col items-center gap-6">
            <button
              disabled
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-lg text-white font-semibold text-base opacity-60 cursor-not-allowed"
            ...
            <p className="text-xs text-muted-foreground text-center">Discord login available at launch.</p>
